	...
	<form id="searchForm" class="form-horizontal search-form">
	    <div class="row">
	    	<div class="search-bar">
                <input id="keywords" name="keywords" class="control-text" type="text" placeholder="团购编号/名称"/>
...
<script type="text/javascript">
	...
	BUI.use(['common/search','common/page'],function (Search) {
        ...
        var store = Search.createStore('${ctx}/admin/sa/grouponAudit/done_json',{pageSize:15});
	...
	function promotionDetail(obj){
        window.location.href = "${ctx}/admin/sa/promotionGroupon/toSave?promotionId=" +obj;
    }
