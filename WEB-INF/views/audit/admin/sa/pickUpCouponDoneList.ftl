	...
	<form id="searchForm" class="form-horizontal search-form">
	    <div class="row">
	    	<div class="search-bar">
                <input id="keywords" name="keywords" class="control-text" type="text" placeholder="提货券编号/名称"/>
...
<script type="text/javascript">
	...
	BUI.use(['common/search','common/page'],function (Search) {
        var columns = [
            {title:'申请人',dataIndex:'applySrcUserName',width:200},
        	{title:'审核对象',dataIndex:'pickupCouponName',width:200,renderer : function(value, rowObj){
                var str = "";
                str = "<a href='javascript:pickupCouponDetail(\""+rowObj.pickupCouponId+"\");'>"+value+"</a>";
                return str;
        	}},
        ...
        var store = Search.createStore('${ctx}/admin/sa/pickUpCouponAudit/done_json',{pageSize:15});
     ...
     * @param obj
     */
	function pickupCouponDetail(obj){
        window.location.href = "${ctx}/admin/sa/pickupcouponCode?pickupCouponId=" +obj;
    }
