	...
	<form id="searchForm" class="form-horizontal search-form">
	    <div class="row">
	    	<div class="search-bar">
                <input id="keywords" name="keywords" class="control-text" type="text" placeholder="优惠券编号/名称"/>
...
<script type="text/javascript">
	...
	BUI.use(['common/search','common/page'],function (Search) {
        var columns = [
        	...
        	{title:'审核对象',dataIndex:'promotionName',width:200,renderer : function(value, rowObj){
                var str = "";
                str = "<a href='javascript:promotionDetail(\""+rowObj.promotionId+"\");'>"+value+"</a>";
                return str;
        	}},
        ...
        var store = Search.createStore('${ctx}/admin/sa/couponAudit/done_json',{pageSize:15});
    ...
    //点击优惠券名跳转到优惠券详情页
	function promotionDetail(obj){
        window.location.href = "${ctx}/admin/sa/promotion/coupons/editCoupon?promotionId=" +obj;
    }
