    ...
    BUI.use(['common/search', 'common/page'], function (Search) {
        var columns = [
            ...
            },
            {
                ...
                if(rowObj.newPrice!=null)
                    return "充值金额￥" + rowObj.newPrice;
                else if (rowObj.oldPrice!=null)
                    return "充值金额-￥" + rowObj.oldPrice;
            }
            },
            {
        ...
        var store = Search.createStore('${ctx}/admin/sa/userPriceAudit/grid_json', {pageSize: 15});
