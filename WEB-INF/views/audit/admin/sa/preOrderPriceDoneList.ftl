...
<script type="text/javascript">
	...
	BUI.use(['common/search','common/page'],function (Search) {
        var columns = [
        	{title:'审核对象',dataIndex:'orderNumber',width:200,renderer : function(value, rowObj){
                var str = "";
                str = "<a href='javascript:orderDetail(\""+rowObj.orderId+"\");'>"+value+"</a>";
                return str;
        	}},
        	{title:'审核内容',dataIndex:'',width:200, renderer : function(value, rowObj){
         		return "价格从￥"+rowObj.oldPrice+"调至￥"+rowObj.newPrice;
            }},
        ...
        var store = Search.createStore('${ctx}/admin/sa/preOrderPriceAudit/grid_json',{pageSize:15});
	...
	function orderDetail(obj){
        window.location.href = "${ctx}/admin/sa/order/toOrderDetail?orderId="+obj;
    }
