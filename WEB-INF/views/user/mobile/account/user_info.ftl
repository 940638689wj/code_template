        ...
        <div class="loginform">
            <ul>
            	<li>
                    ...
                    <div class="bd">
                        <div class="info">
                            <div class="input-wrap"><input type="text" value="${(user.phone)!}" readonly="readonly" id="phone"><span class="delete"></span></div>
                        </div>
                    </div>
                </li>
                <li>
                ...
                <li>
                    ...
                    <div class="bd">
                        <div class="info">
                            <div class="input-wrap"><input type="text" value="${(user.userName)!}" id="realName"><span class="delete"></span></div>
                        </div>
                    </div>
                </li>
                <li>
                ...
                <li>
                    ...
                    <div class="bd">
                        <div class="info">
                            <div class="input-wrap"><input type="text" value="<#if userInfoDTO.provinceName?? && userInfoDTO.provinceName?has_content>${userInfoDTO.provinceName!}</#if><#if userInfoDTO.cityName?? && userInfoDTO.cityName?has_content>-${userInfoDTO.cityName!}</#if><#if userInfoDTO.countyName?? && userInfoDTO.countyName?has_content>-${userInfoDTO.countyName!}</#if>" id="showCityPicker"></div>
                        </div>
                    </div>
                </li>
                <li>
...
function submit(){
    ...
    for (i = 0; i < genderArray.length; i++) {
        if (genderArray[i].value == $("#sexCd").val()) {
            gender = i;
        }
    }
    //日期处理
