    ...
    <div class="title-bar">
        <div class="userinfo-box">
            ...
            <ul>
                ...
                <li>URL返利总额：${(userInfoDTO.urlRebateAmt)!0}</li>
            </ul>
        </div>
    </div>
    <div class="content-top">
    	<div class="content-top">
            <form id="urlForm" class="form-horizontal search-form mb0" method="get">
...
<script type="text/javascript">
	...
	BUI.use(['common/search','common/page'],function (Search) {
        var columns = [
            ...
            {title:'订单号',dataIndex:'orderNumber',width:70, renderer : function(value, rowObj){
                return value;
            }}
        ];
        var store = Search.createStore('/admin/sa/user/grid_json6',{pageSize:15});
	...
	function exportDist(){
		var formSerialize = $("#urlForm").serialize();
		location.href ="${ctx}/admin/sa/userExcel/exportDist?t=2&"+formSerialize;
