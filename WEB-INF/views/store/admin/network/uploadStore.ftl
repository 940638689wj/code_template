...
<head>
    ...
    <script type="text/javascript">
         ...
         *
         */
        var importUploadPath = "${ctx}/admin/network/storeExcel/importStore";
        function importFile(){
                ...
                success: function (data, status) {
                    if(data.result == "success"){
                        ...
                        BUI.Message.Alert(data.message);
                         ...
                         setTimeout(function () { 
							      location.href = "${ctx}/admin/network/userStore/storeManageList";
						    }, 2000);
...
<div class="container">
    <ul class="breadcrumb">
        <li><a href="JavaScript:history.go(-1);">返回门店列表</a> <span class="divider">&gt;&gt;</span></li>
        <li class="active">导入门店</li>
    </ul>
    <div class="flow-steps">
        <ol class="num5">
            <li class="current"><i class="num">1</i>导入门店文件文件</li>
        </ol>
    </div>
    <form id="uploadFileForm" name="uploadFileForm" class="form-horizontal" action="#" method="post">
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <a href="${ctx}/static/admin/excel/networkStore.xls" style="color: #ff0000">点击这里下载模版</a>
