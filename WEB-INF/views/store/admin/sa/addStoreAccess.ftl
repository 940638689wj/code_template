...
<div class="container">
   ...
   <form id="J_Form" class="form-horizontal" action="${ctx}/admin/sa/userStore/addStoreReviewForm" method="post">
        ...
        var form = new Form.Form({
            ...
            callback: function (data) {
                if (app.ajaxHelper.handleAjaxMsg(data)) {
                    ...
                    app.page.open({
                        href:"${ctx}/admin/sa/userStore/toStoreAccess?storeId=${(store.storeId)!}",
                        isClose: true,
                        reload: true
                    })
                }
