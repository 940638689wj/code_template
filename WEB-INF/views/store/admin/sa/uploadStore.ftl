...
<head>
    ...
    <script type="text/javascript">
         ...
         *
         */
        var importUploadPath = "${ctx}/admin/sa/storeExcel/importStore";
        function importFile(){
                ...
                success: function (data, status) {
                    if(data.result == "success"){
                        ...
                        BUI.Message.Alert(data.message);
                         ...
                         setTimeout(function () { 
							      location.href = "${ctx}/admin/sa/userStore/storeManageList";
						    }, 2000);
    ...
    <form id="uploadFileForm" name="uploadFileForm" class="form-horizontal" action="#" method="post">
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <a href="${ctx}/static/admin/excel/store.xls" style="color: #ff0000">点击这里下载模版</a>
