...
<div class="container">
    <ul class="breadcrumb">
        <li><a href="${ctx}/admin/sa/userStore/toStoreAccess?storeId=${(storeReview.storeId)!}" >门店评价管理</a > <span class="divider">&gt;&gt;</span></li>
        <li class="active">评价</li>
    </ul>
   <form id="J_Form" class="form-horizontal" action="${ctx}/admin/sa/userStore/updateStoreReviewForm" method="post">
        ...
        var form = new Form.Form({
            ...
            callback: function (data) {
                if (data) {
                    ...
                    app.page.open({
                        href:"${ctx}/admin/sa/userStore/toStoreAccess?storeId=${(storeReview.storeId)!}",
                        isClose: true,
                        reload: true
                    });
                }else{
