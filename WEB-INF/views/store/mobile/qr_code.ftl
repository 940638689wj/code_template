        ...
        <#if showTitle?? && showTitle>
	        <header class="mui-bar mui-bar-nav">
	            <a class="mui-icon mui-icon-left-nav" onclick="history.go(-1)"></a>
		            <h1 class="mui-title">门店二维码</h1>
	            <a class="mui-icon"></a>
	        </header>
        </#if>

        <div class="mui-content">
            <div class="sis-qrcode"><img src="${ctx}/m/store/getImg?storeId=${storeId}"></div>
            <div class="sis-qrcode-info">
                <div class="pic" style="background-image: url('${staticPath}/images/sis-qrcode-info.png')"></div>
                <h3>enito</h3>
                <p>扫一扫二维码，一起欢乐购</p>
            </div>
        </div>
