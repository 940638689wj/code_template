...
<div class="container">
    ...
    <div class="content-body">
        <form id="newExpress_Form" class="form-horizontal" action="${ctx}/admin/sa/brand/addExpressTemplateSave" method="post">
            <div class="form-content">
                <div class="row">
                    <div class="control-group">
                        <label class="control-label"><s>*</s>运费模板名称：</label>
                        <div class="controls">
                            <input type="text" value="" class="input-normal control-text" name="templateName">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="control-group">
                        ...
                        <div class="controls"><!--<button class="button" id="addExpressTemplateCalc" type="button">添加</button>-->
                       	 按重量计算运费
                        </div>
                    </div>
                </div>
            ...
            <table cellspacing="0" class="table table-bordered" id="calcTable">
                <tbody id="calcTableBody">
	                ...
	                <tr id="CalcTableChild">
	                	...
	                	<!--<td><input type="hidden" class="input-normal control-text" name="calcTypeCd_1" readonly="true" value="<"></td> -->
	                    <th><!--<input type="text" class="input-normal control-text" name="limitOrderPayAmt_1">-->默认运费</th>
	                    <td><input type="text" class="input-normal control-text" name="firstValue_0"></td>
	                    <td><input type="text" class="input-normal control-text" name="firstPrice_0"></td>
	                    <td><input type="text" class="input-normal control-text" name="continueValue_0"></td>
	                    <td><input type="text" class="input-normal control-text" name="continuePrice_0"></td>
	                    <!--<td></td>-->
	                    <!--<td><a href="javascript:void(0);" onclick = "return false;" >删除</a></td>-->
	                    <!--<td><a href="javascript:void(0);" onclick = "deleteCalc(this)" >删除</a></td>-->
	                </tr>
                </tbody>
            </table>
            ...
            <table cellspacing="0" class="table table-bordered">
                ...
                <tr>
                    <!--<td>枫亭镇</td>
                    <td><a href="javascript:void(0);">设为中心点</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0);">删除</a></td> -->
                </tr>
                </tbody>
            </table>
    ...
    <div id="Content" class="hide">
                ...
                <div class="control-group">
                    ...
                    <!--<div class="controls control-row-auto"> -->
                        ...
                        <#-- </select>
                            ...
                            <option id='${provinceList.id!}'>${provinceList.areaName!}</option>
        					</#list>-->
                    <!--</div> -->
                </div>
            </div>
        ...
        <div class="area-list lbdarea-list" id = "lbdarea-list">
        	<div class="item">
            	<label class="checkbox area-label"><input onclick="selectAllChild(this);" id="selectAll" type="checkbox" /><span>全选</span>&nbsp;&nbsp;&nbsp;&nbsp;</label>
        	</div>
