...
<head>
    ...
    <script type="text/javascript">
        function goToUploadFile(){
            window.open('${ctx}/admin/sa/improtPrice','_self');
        }
...
<div class="container">
    <ul class="breadcrumb">
        ...
        <li class="active">导入价格</li>
    </ul>
    <div class="flow-steps">
        <ol class="num4">
            <li  class="current-prev"><i class="icon-ok"></i>导入商品价格单</li>
            <li  class="current"><i class="num">2</i>预览确认</li>
            <li  class="last"><i class="num">3</i>导入结果</li>
        </ol>
    </div>
    <form id="confirmForm" class="form-horizontal" method="post" action="${ctx}/admin/sa/improtPrice/preview">
            ...
            <tbody>
                <#if failureList?has_content>
                    ...
                    <tr>
                        ...
                        <td>${(one.nowPrice)!}</td>
                        <td style="color: #ff0000">${(one.defaultPrice)!}</td>
