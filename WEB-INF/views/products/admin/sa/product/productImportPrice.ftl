...
<#include "${ctx}/includes/sa/header.ftl"/>
    ...
    <script type="text/javascript">
        ...
        function importFile(){
            ...
            $.ajaxFileUpload({
                url : '${ctx}/admin/sa/improtPrice/importFiles',
                secureuri: false,
                ...
                success: function (data) {
                    if(data.result == "success"){
                        app.page.open({
                            href:'${ctx}/admin/sa/improtPrice/preview'
                        });
                    } else {
        ...
        function getTemplate(){
            window.open('${ctx}/admin/sa/improtPrice/getTemplate');
        }
...
<div class="container">
    ...
    <div class="flow-steps">
        <ol class="num5">
            <li class="current"><i class="num">1</i>导入商品价格单</li>
