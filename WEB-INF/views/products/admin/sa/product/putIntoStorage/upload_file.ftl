...
<head>
    ...
    <script type="text/javascript">
        ...
        function importFile(){
            ...
            $.ajaxFileUpload({
                url : '${ctx}/admin/sa/putIntoStock/importFiles',
                secureuri: false,
                ...
                success: function (data) {
                    if(data.result == "success"){
                        app.page.open({
                            href:'${ctx}/admin/sa/putIntoStock/preview'
                        });
                    } else {
        ...
        function getTemplate(){
            window.open('${ctx}/admin/sa/putIntoStock/getTemplate');
        }
...
<div class="container">
    ...
    <div class="flow-steps">
        <ol class="num5">
            <li class="current"><i class="num">1</i>导入商品入库单</li>
