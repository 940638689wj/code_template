...
<div class="container">
    <ul class="breadcrumb">
        ...
        <li class="active"><#if productCategory?has_content && productCategory.categoryId?has_content>编辑<#if productTypeCd==1>商品<#else>菜品</#if>分类<#else>添加<#if productTypeCd==1>商品<#else>菜品</#if>分类</#if></li>
    </ul>
        ...
        <div class="form-content">
                <div class="row">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input value="${(productCategory.categoryName)!?html}" name="categoryName" data-rules="{required:true}" class="input-normal control-text">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <#if parentCategoryList?? && parentCategoryList?has_content>
			                    ...
			                    <option value="${(parentCategory.categoryId)!}" <#if productCategory??&&productCategory?has_content><#if parentCategory.categoryId==parentId>selected="selected"</#if></#if>>${(parentCategory.categoryName)!}</option>
			                	</#list>
			            		</#if>
                            </select>
                        </div>
                ...
                <div class="row">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input value="${(productCategory.displayId)!}" name="displayId" data-rules="{required:true}" class="input-normal control-text">
                        </div>
                    </div>
                </div>
                <!-- 类别分组 -->
