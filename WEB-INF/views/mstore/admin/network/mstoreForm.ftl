...
<div class="container">
    ...
    <div class="content-body">
        <form id="J_Form" class="form-horizontal" action="${ctx}/admin/network/mstore/updateMstoreForm" method="post">
        	<input type="hidden" name="userId" value="${(mstoreDTO.userId)!?html}"/>
        	<table cellspacing="0" class="table table-info">
	            <tbody>
	            <tr>
	                <th>微店名称：</th>
	                <td><div class="input-wrap1"><input name="mstoreName" value="${(mstoreDTO.mstoreName)!?html}" class="control-text" type="text"></div></td>
	                <th>身份证号：</th>
	                <td><div class="input-wrap1"><input name="identityId" data-messages="{regexp:'只能输入数字和字母'}" data-rules="{regexp:/^[A-Za-z0-9]+$/}" value="${(mstoreDTO.identityId)!?html}" class="control-text" type="text"></div></td>
	            </tr>
	            <tr>
	                <th>地区:</th>
	                <td>
	            ...
	            <tr>
	                <th>微店等级：</th>
	                <td>
	                    <select name="mstoreLevelId" class="span4">
	                ...
	                <th>所属大区：</th>
	                <td>
	                    <select class="span4" name="regionId" id="regionId"  disabled="disabled">
	            ...
	            <tr>
	                <th>所属分公司：</th>
	                <td>
	                    <select class="span4" name="branchId" id="branchId" disabled="disabled">
	                    	<option value="">-- 请选择 --</option>
	                ...
	                <th>所属办事处：</th>
	                <td>
	                    <select class="span4" name="officeId" id="officeId"  disabled="disabled">
	                    	<option value="">-- 请选择 --</option>
	            ...
	            <tr>
	                <th>微店状态：</th>
	                <td>
	                    <select name="statusCd" class="span4">
	                ...
	                <th>上级会员手机号：</th>
	                <td>
	                    ${(mstoreDTO.parentUserPhone)!?html}
	                </td>
	            </tr>
	            <tr>
	                <th>微店佣金比例：</th>
