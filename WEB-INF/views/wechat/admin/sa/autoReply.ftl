        ...
        <div class="form-content">
			...
			<div class="control-group" id="textreply">
				...
				<div class="controls control-row-auto">
					<div class="txtArea">
						...
						<div class="editArea">
							<textarea id="welcome" name="welcome" style="display: none;"><#if content??>${content?html}</#if></textarea>
					...
					<span class="maroon">*</span><span class="help-inline">必填,当没有匹配用户输入的信息时自动回复语 </span>
            ...
            <div class="control-group" id="multiArticle">
                ...
                <div class="controls art_table control-row-auto">
                    ...
                    <#--<@securityAuthorize ifAnyGranted="PERMISSION_MAIN_AOTO_REPLY_MESSAGE_EDIT">-->
...
<script>
    ...
    $(function(){
                    ...
                    if(id && id!=null)
                    {
                        ...
                        $.post('${ctx}/admin/sa/wechat/addArticleForm',submitData,function(data) {
                            if (data.result == "true") {
                                ...
                                app.page.open({
                                    href:'${ctx}/admin/sa/wechat/autoReply?type=1'
                                });
                            } else {
        ...
        $("#submitbtn").click(function() {
            ...
            if (submitData.answertype == 0) {
                if($.trim($("textarea[name='welcome']").val())==""){
                    app.showError(data.message || "内容不可以为空");
                    return false;
                }
            ...
            $.post('${ctx}/admin/sa/wechat/autoReply',submitData,function(data) {
        ...
        $("#addArticle").click(function(){
            ...
            //addArticleDialog.get('loader').load({from : 'autoReply'});
            //return false;
        });
