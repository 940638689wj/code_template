        ...
        <div id="edit-div" class="form-content">
            <div class="row">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input value="${(couponFormDTO.promotionName)!?html}" name="promotionName"
            ...
            <div class="row">
                <div class="control-group">
                    ...
                    <div class="controls control-row-auto">
                        <textarea name="promotionDesc" data-rules="{required:true}"
                ...
                <div class="control-group">
                    ...
                    <#else>
                        <div class="couponConditionPanel">
                            ...
                            &nbsp;&nbsp;&nbsp;
                            <a href="javascript:void(0);" class="addCouponCondition">+优惠券面额</a>
                            <a href="javascript:void(0);" class="delCouponCondition" style="display: none;">删除优惠券面额</a>
                        </div>
                    </#if>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input value="${(couponFormDTO.couponTotalNum)!}" name="couponTotalNum"
                    ...
                    <div class="controls">
                        <label class="checkbox">
                            ...
                            <#if (couponFormDTO.isPreGenerate)?? && (couponFormDTO.isPreGenerate==1)>
                                    ...
                                    type="checkbox">
                            (通过网站点击领取的请不要选预生成，短信等直接给优惠码的请选择预生成)
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input value="${(couponFormDTO.couponPersionQuotaNum)?default(1)}"
        ...
        <#elseif couponFormDTO?? && couponFormDTO.pushTypeCd?has_content && (couponFormDTO.pushTypeCd)?? && couponFormDTO.pushTypeCd==4>
            ...
            <div class="row">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <label class="radio">
                            <input type="radio" name="pushTypeCd" value="1"
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <label class="radio">
                            <input type="radio" name="pushTypeCd" value="4"
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <label class="radio">
                            <input type="radio" name="pushTypeCd" value="2"
                            <#if pushTypeCd==2> checked="checked" </#if>/>
                        </label>
                        每笔订单完成
                        <input value="${(couponFormDTO.couponPushOrderAmtLimit)!}"
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <label class="radio">
                            <input type="radio" name="pushTypeCd" value="3"
                ...
                <div class="control-group">
                    ...
                    <#if (couponFormDTO.regEndTime)?has_content>
                        <input type="text" class="calendar control-text" name="regEndTime" data-rules="{required:true}"
                               value="${(couponFormDTO.regEndTime)!}">
                    <#else>
                        <input type="text" class="calendar control-text" name="regEndTime" data-rules="{required:true}"
                               value="2999-12-31">
                    </#if>
            ...
            <div class="row">
                <div class="control-group">
                    ...
                    <#assign isAllUser = (couponFormDTO.isAllUserJoin)?default(false)/>
                        <label class="checkbox">
                            <input <#if isAllUser> checked="checked"</#if> id="allUser"
                                                   name="activityUsers" value='1' type="radio">
                            全选
                        </label>&nbsp;&nbsp;
                        <label class="checkbox">
                            <input name="activityUsers"
                ...
                <ul class="toolbar">
                    <li>
                        ...
                        <input type="hidden" name="selectOldUserIds" id="selectOldUserIds"
                               <#if userIds?? && userIds?has_content>value="${userIds}"</#if>>
                        <button id="choiceUserBtn" type="button" class="button button-primary">
                ...
                <ul class="toolbar">
                    <li>
                        ...
                        <input type="hidden" name="selectOldProductIds" id="selectOldProductIds"
                               <#if productIds?? && productIds?has_content>value="${productIds}"</#if>>
                        <button id="choiceProductBtn" type="button" class="button button-primary">
...
<script type="text/javascript">
    ...
    var userColumns = [
        ...
        {
            title: '操作', dataIndex: '', width: 120, renderer: function (value, obj) {
            var delStr = '<span class="grid-command btn-delUser">删除</span>';
            return delStr;
        }
        }
    ];
...
//            }
            ...
            if ($($("input[name='activityProducts']").filter(":checked").get(0)).attr('id') == "appointProduct") {
                ...
                if ($('#selectOldProductIds').val() != '') {
                    ...
                    if (j != oldProductIdArr.length) {
                        app.showError('之前的商品不能删除!请重新编辑!');
                        goOn = false;
                    }
                }
