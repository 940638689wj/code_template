...
<head lang="en">
    ...
    <link rel="stylesheet" href="${ctx}/static/mobile/css/gmu.css"/>
    <link rel="stylesheet" href="${ctx}/static/mobile/css/ecmmobile.css"/>
...
<script>
    ...
    if(id != 0){
        frameConfigUrl = "${ctx}/admin/sa/store/layoutManage/getIsPushFrameJson/${(decoration.id)!}";
    }
    var layoutData = ${(data)!};
    require.config({
