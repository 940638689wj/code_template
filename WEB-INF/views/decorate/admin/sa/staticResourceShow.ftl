...
<script type="text/javascript">
    ...
    $(function(){
	   ...
	   <#if platform?has_content && "mobile"==platform>
        var styleUrl = '${ctx}/static/mobile/css/ecmmobile.css';
        var templateUrl = '${ctx}/static/mobile/template<#--/${templateId}-->/css/tmpl.css';
        var templateThemeUrl = '${ctx}/static/mobile/template<#--/${templateId}-->/themes/${templateTheme!}/css/theme.css';
        var staticResourceCssUrl = '${ctx}/common/mobile/css';
	<#--<#else>
