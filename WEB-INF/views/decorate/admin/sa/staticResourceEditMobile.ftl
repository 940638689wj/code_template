...
<#assign selectedHtml="static_resource_css_mobile"/>
<!DOCTYPE html>
<html>
<head>
    <title></title>
...
<div class="box">
    <div class="menu">
        <div id="static_resource_css_mobile" class="cell cell-css">
            <a  href="${ctx}/admin/sa/mobile/decorate/staticResourceShow?platform=mobile&key=static_resource_css_mobile" target="index_edit_iframe">手机端css</a>
        </div>
        <div id="static_resource_js_mobile" class="cell cell-js">
            <a  href="${ctx}/admin/sa/mobile/decorate/staticResourceShow?platform=mobile&key=static_resource_js_mobile" target="index_edit_iframe">手机端js</a>
        </div>
    </div>

    <div class="content">
        <iframe name="index_edit_iframe" id="index_edit_iframe" src="${ctx}/admin/sa/mobile/decorate/staticResourceShow?platform=mobile&key=${selectedHtml}" frameborder="0"></iframe>
    </div>
</div>
