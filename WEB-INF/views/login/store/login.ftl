...
<head>
    ...
    <script type="text/javascript" src="${staticPath}/admin/js/jquery-1.8.1.min.js"></script>
        ...
        if (window.top!=window.self){
            var toUrl = '${ctx}/admin/store/main.html';
...
<body class="page-login">
    <div class="loginWrap">
        <div class="loginlogo"><img src="${ctx}/static/admin/images/storessystem_text.png" alt="门店后台管理系统"></div>
        <div class="loginbox">
            <form method="POST" id="jForm" action="${ctx}/admin/store/login_admin_post">
                <h1>欢迎登录</h1>
                <ul class="loginform">
                    <li>
                        <div class="txt">
                    ...
                    <li>
                        <div class="txt txt-vcode">
                            <input type="text" name="randomCode" id="randomCode" placeholder="输入验证码">
                        </div>
