                 ...
                 <form id="searchForm" name="searchForm" class="form-horizontal search-form">
                    <div class="row">
                        <div class="control-group span">
                            ...
                            <div class="controls">
                                <input type="text" id="storeNumber" name="storeNumber" class="control-text">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="control-group span">
                            ...
                            <div class="controls">
                                <input type="text" name="storeName" id="storeName" class="control-text">
                            </div>
                        </div>
                    </div>
                   <div class="row">
 ...
 $.fn.status=function(key){
    ...
    BUI.use(['common/search','common/page'],function (Search) {
       columns = [
		...
		{
            title : '门店类型',
            dataIndex :'storeTypeCd',
            width:150,
            renderer : function(value, rowObj){
	            return $.fn.storeTypeCd(value);
        }},
        {
            title : '订单号',
        ...
        var store = Search.createStore("${ctx}/admin/network/order/grid_json");
        ...
        function batchExport(){
        	var a=$('#searchForm').serialize();
    			location.href ="${ctx}/admin/network/order/storeExportOrder?"+a;
