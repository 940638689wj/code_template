...
<div class="container">
    ...
    <div class="content-body">
        ...
        <table cellspacing="0" class="table table-info " >
            ...
            <tr>
                <th>订单号:</th>
                <td>${(storeOrder.orderNumber)!}<#if orderInfo.Is_Store_First_Order><span class="text-red">首单</span></#if></td>
                <th>订单来源系统:</th>
            ...
            <tr>
                ...
                <th>下单时间:</th>
                <td>${(storeOrder.createTime?datetime)!}</td>
                <th>订单状态:</th>
                <td>${DICT('ORDER_STATUS_CD','${(storeOrder.orderStatusCd)!}')}</td>
            </tr>
            <tr> 
                <th>订单属性:</th>
